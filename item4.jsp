...
<head>
	...
	try {
		...
		String query = "SELECT * FROM itemtable where itemid=4";
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="single-blog">
						<article>
								...
								<div id="post-carousel" class="carousel slide" data-ride="carousel">			
									<div class="carousel-inner">
										<div class="item active">
											<img src="images/item4/01.png" alt="">
										</div>
										<div class="item">
											<img src="images/item4/02.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item4/03.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item4/04.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item4/05.png" alt="">			
										</div>
							...
							<h4 class="post-title"><a href="">Lamborghini Aventador.</a></h4>
							<div class="post-meta text-uppercase">
								<span>Appril 3, 2021</span>
								<span>In <a href="">Design</a></span>
								<span>By <a href="">Lamborghini</a></span>
							</div>
							<div class="post-article">
								The flagship supercar unveiled at the Geneva Motor Show in March 2011. It is the successor to Murcielago and the fifth flagship.
								Aventador means windmill in Spanish. Considering that other vehicles of Lamborghini used radical and masculine names such as 'explosive', 'selfish', 'poison', and 'devil', it may seem a bit strange, but following Lamborghini's tradition, 'Aventador' ' is derived from a bullfighting bull.
							</div>
				...
				<div class="col-md-3">
					...
					<div class="sidebar-widget">
						<form action="update.jsp?itemid=4" method="post">
					...
					<div class="sidebar-widget">
						...
						<ul class="content-flickr">
							<li>
                                <a href="#" title="">
                                    <img class="img-responsive" src="images/item4/g1.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item4/g2.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item4/g3.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item4/g4.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item4/g5.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item4/g6.png" alt="">
                                </a>
                            </li>
						</ul>
					</div>
					<div class="sidebar-widget">
						...
						<div class="tagcloud">
							...
							<a href="">LP 740-4S</a>
							<a href="">LP 750-4SV</a>
							<a href="">LP 770-4SVJ</a>
							<a href="">LP 780-4 ULTIMAE</a>
						</div>
					</div>
				</div>
			</div>
