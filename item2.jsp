...
<head>
	...
	try {
		...
		String query = "SELECT * FROM itemtable where itemid=2";
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="single-blog">
						<article>
								...
								<div id="post-carousel" class="carousel slide" data-ride="carousel">			
									<div class="carousel-inner">
										<div class="item active">
											<img src="images/item2/01.png" alt="">
										</div>
										<div class="item">
											<img src="images/item2/02.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item2/03.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item2/04.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item2/05.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item2/06.png" alt="">			
										</div>
							...
							<h4 class="post-title"><a href="">Lamborghini URUS.</a></h4>
							<div class="post-meta text-uppercase">
								<span>Appril 3, 2023</span>
								<span>In <a href="">Design</a></span>
								<span>By <a href="">Lamborghini</a></span>
							</div>
							<div class="post-article">
								It is Lamborghini's large SUV, and is the second SUV produced by Lamborghini after the LM002. In keeping with Lamborghini's naming convention of using bullfighting terms for its vehicles, the Urus is named after an ancient breed of cattle from which the bull was ancestor.
							</div>
				...
				<div class="col-md-3">
					...
					<div class="sidebar-widget">
						<form action="update.jsp?itemid=2" method="post">
					...
					<div class="sidebar-widget">
						...
						<ul class="content-flickr">
							<li>
                                <a href="#" title="">
                                    <img class="img-responsive" src="images/item2/g1.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item2/g2.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item2/g3.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item2/g4.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item2/g5.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item2/g6.png" alt="">
                                </a>
                            </li>
						</ul>
					</div>
					<div class="sidebar-widget">
						...
						<div class="tagcloud">
							<a href="">SUV</a>
							<a href="">ST-X</a>
							<a href="">Performante</a>
							<a href="">Urus S</a>
							<a href="">Pearl Capsule</a>
						</div>
					</div>
				</div>
			</div>
