...
<head>
	...
	try {
		...
		String query = "SELECT * FROM itemtable where itemid=1";
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="single-blog">
						<article>
								...
								<div id="post-carousel" class="carousel slide" data-ride="carousel">			
									<div class="carousel-inner">
										<div class="item active">
											<img src="images/item1/01.png" alt="">
										</div>
										<div class="item">
											<img src="images/item1/02.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item1/03.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item1/04.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item1/05.png" alt="">			
										</div>
										<div class="item">
											<img src="images/item1/06.png" alt="">			
										</div>
							...
							<h4 class="post-title"><a href="">Lamborghini Huracán.</a></h4>
							<div class="post-meta text-uppercase">
								<span>Appril 3, 2022</span>
								<span>In <a href="">Design</a></span>
								<span>By <a href="">Lamborghini</a></span>
							</div>
							<div class="post-article">
								The Lamborghini Huracán is a sports car produced by the Italian automaker Lamborghini, replacing the previous V10 model, the Gallardo. The Huracán was unveiled online in December 2013, and was officially unveiled worldwide at the 2014 Geneva Auto Show. The vehicle was put on the market in the second quarter of 2014
							</div>
				...
				<div class="col-md-3">
					...
					<div class="sidebar-widget">
						<form action="update.jsp?itemid=1" method="post">
					...
					<div class="sidebar-widget">
						...
						<ul class="content-flickr">
							<li>
                                <a href="#" title="">
                                    <img class="img-responsive" src="images/item1/g1.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item1/g2.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item1/g3.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item1/g4.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item1/g5.png" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img class="img-responsive" src="images/item1/g6.png" alt="">
                                </a>
                            </li>
						</ul>
					</div>
